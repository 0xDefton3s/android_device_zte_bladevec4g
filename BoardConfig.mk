...
VENDOR_PATH := device/zte/bladevec4g
...
TARGET_KERNEL_SOURCE := kernel/zte/bladevec4g
BOARD_KERNEL_CMDLINE := console=ttyHSL0 androidboot.hardware=qcom user_debug=31 msm_rtb.filter=0x37 androidboot.selinux=permissive
